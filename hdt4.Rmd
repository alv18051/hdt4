...
```{r}
casas <- read.csv("C:\\Users\\javie\\Desktop\\U\\2023f\\mineria\\hdt4\\train.csv")
```
...
Intermedias o Caras. Los límites de estas clases deben tener un fundamento en la distribución de los datos de precios, y estar bien explicados 
